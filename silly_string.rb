...
phrase.lowercase = "IM NOT SHOUTING"
...
sentence.gsub(/[Aa]/, 'Oo')        = "Astounding aardvarks, arguably an ancient animal, always ate apples and acorns and artichokes all around Athens, amazing!"
